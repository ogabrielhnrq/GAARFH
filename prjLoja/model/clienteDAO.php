   ...
   class ClienteDAO {
        ...
        public function exclui() {
            try {
                ...
                // Passo 3 -  Executa o SQL
                $comando = $con->prepare( "DELETE FROM CLIENTE WHERE NOME = :nome");
                
                $codigo = $this->cliente->getCod_cliente();
                  
                $comando->bindParam(':nome', $codigo , PDO::PARAM_INT);
        ...
        public function lista() {
          try{
                ...
                $comando = $con->prepare( "SELECT COD_CLIENTE AS CODIGO, NOME, EMAIL, ENDERECO, CIDADE FROM CLIENTE");
